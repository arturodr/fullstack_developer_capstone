...
class CarMake(models.Model):
    ...
    country_of_origin = models.CharField(max_length=100, verbose_name="País de origen", blank=True)
...
class CarModel(models.Model):
    ...
    dealer_id = models.IntegerField(verbose_name="ID del Concesionario", null=True, blank=True)
    name = models.CharField(max_length=100, verbose_name="Nombre")
